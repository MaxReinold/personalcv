...
import { SkillsByCategory, SkillType } from "../types";
        ...
        <div className="flex flex-col gap-4">
            <div className="text-2xl font-semibold mb-2">Skills</div>
            {
                Object.keys(skills).map((skillKey, index) => {
                    const skillArray:SkillType[] = skills[skillKey];
                    return (
                        <div key={index}>
                            <div className="ml-4 text-lg">{skillKey}</div>
                            <div className="flex flex-row flex-wrap w-full gap-2">
                                {
                                    skillArray.map((skill, index) => <Skill skill={skill} key={index}/>)
                                }
                            </div>
                        </div>
                    )
